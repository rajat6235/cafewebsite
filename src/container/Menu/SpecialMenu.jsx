  ...
  <div className="app__specialMenu flex__center section__padding" id="menu">
    ...
    <div className="app__specialMenu-menu">
      ...
      <div className="app__specialMenu-menu_wine  flex__center takeAway">
        ...
        To order your fresh, healthy takeaway food for collection from the café,
           <br/>
        simply call
         <a href="tel:9888861516" className='PhoneNum'>9888861516</a><a href="tel:9888861517"className='PhoneNum'>9888861517</a>
        <br/>
        or Whatsapp us on  <a href="tel:9888861517"className='PhoneNum'> <i class="fa fa-whatsapp fa-lg"></i>9888861517 </a>
        </div>
        <div className='orderButtonsContainer'>
      <button type="button" className="takeawaymenu__button">View TakeAway Menu</button>
        <a id="button" className='orderButton' href="https://gymjunkiecafe.es/"></a>
        {/* <a id="button" className='orderButton' href="https://gymjunkiecafe.es/"> <p className='ordertext'>ORDER ON</p> 	&nbsp;<img className='swiggyIcon' src={images.swiggy}/></a> */}
       {/* <div className='robContainer'> <a id="button" className='orderButton' href="https://gymjunkiecafe.es/"><p className='ordertext'>ORDER ON</p>&nbsp;<img className='robIcon' src={images.logo1}/> </a><p className='discount'>(&nbsp;23% off on <br/> online menu)</p></div> */}
        </div>
